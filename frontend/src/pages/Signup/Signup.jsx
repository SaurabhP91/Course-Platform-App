...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:3000/api/userroute/register", {
                method: "POST",
        ...
        <div className='flex flex-col h-screen container mx-auto items-center justify-center text-white my-5'>
            ...
            <div className='bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] mt-20 '>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='mb-4'>
                        <label htmlFor='firstname' defaultValue='firstname'className='text-gray-400 mb-2'>
                            Firstname
                        </label>
                        <input type='text' id='firstname'  className='w-full p-3 rounded-md bg-gray-800 border 
                        border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500'
                        placeholder='Type your firstname' onChange={(e) => setFirstName(e.target.value)}/>
                    </div>
                    ...
                    <div className='mb-4'>
                        <label htmlFor='lastname' className='text-gray-400 mb-2'>
                         ...
                         <input type='text' id='lastname' className='w-full p-3 rounded-md bg-gray-800 border 
                        border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500'
                        placeholder='Type your lastname' onChange={(e) => setLastName(e.target.value)}/>
                    </div>
